...
public:
    ...
    ~tDynamicObject()
    {
        ...
        if (metrichistogram != NULL) delete metrichistogram;
        if (texture != NULL) delete texture;
        if (particulate != NULL) delete particulate;
        if (zernike != NULL) delete zernike;
    }//end ~tDynamicObject
     ...
     */
    void
    setData(string parameter, char *data)
    {
    ...
    void
    allocateDynamicType(stByte* tmp, tDynamicType* object)
    {
        // copy the size
        if (object != NULL)
        {
    ...
    void
    unserializeDynamicType(const stByte *data, tDynamicType* object)
    {
        int size;
