...
Parser::Parser(Connections::eConnections connectionsEnum, const std::string& input, const std::string& username, const std::string& password, MetricTreeManager *treemanager) {
...
void Parser::parameter_reference() {
    ...
    if (errors == 0)
        datadictionary->getSirenQueries()->createMetricInsertParameter(MetricCode, ExtractorCode, ParameterName, ParameterAlias, ParameterType, ParameterWeight, CommandList);
}
