...
public:
    ...
    std::string TimeInMilliseconds(time_t t)
    {
        long ms = t*1000;
    ...
    */
    ...
    Parser(Connections::eConnections connectionsEnum, const std::string& input, const std::string& username, const std::string& password, MetricTreeManager *treemanager);
    ...
    */
    ...
    /**
    * Error() returns the error messages.
    */
    ...
    */
    std::vector<std::string> *ReturnCommands()
    {
        return CommandList;
    }
    ...
    */
    std::vector<std::string> *ReturnTokenList();

    /**
    * Adds an error message to error string
    */
...
private:
    ...
    */
    void Match(std::string Identifier, int TokenType);
    ...
    */
    std::vector<std::string> *CIAList;

    /**
    * Stores the current particulate attribute
    */
    std::vector<std::string> *CPAList;

    /**
    * Stores the current audio attribute
    */
    std::vector<std::string> *CAAList;
    ...
    */
    std::vector<std::string> *MetricReferenceList;
    ...
    */
    std::vector<std::string> *ImgAttribList;

    /**
    * Stores the audio attribute list
    */
    std::vector<std::string> *AudAttribList;

    /**
    * Stores the insert column list
    */
    std::vector<std::string> *InsertColList;

    /**
    * Stores the insert value list
    */
    std::vector<std::string> *InsertValueList;

    /**
    * Stores a list of the image attribute position
    */
    std::vector<std::string> *ImgAttribPosList;

    /**
    * Stores a list of the audio attribute position
    */
    std::vector<std::string> *AudAttribPosList;
    ...
    */
    void sql_manipulation_statement();
